"""Guards for the fast reproduction path: the shipped frozen BEIR/nq sample and E3 contrast.
...
def test_e3_false_purge_contrast_on_sample():
    ...
    res = run_e3_granularity(str(SAMPLE), poison_pool, n_documents=50, poison_per_doc=3)
    ...
    # partially-poisoned document. This is the headline E3 contrast (0.00 vs ~0.52).
